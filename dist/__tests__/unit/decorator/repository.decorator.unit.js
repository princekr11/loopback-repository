...
MyController = (0, tslib_1.__decorate)([
    (0, tslib_1.__param)(0, (0, __1.repository)('noteRepo')),
...
describe('repository decorator', () => {
    ...
    it('throws not implemented for class-level @repository', () => {
        (0, testlab_1.expect)(() => {
            ...
            Controller1 = (0, tslib_1.__decorate)([
                (0, __1.repository)('noteRepo')
                // eslint-disable-next-line @typescript-eslint/no-unused-vars
            ], Controller1);
    ...
    it('supports @repository(model, dataSource) by names', async () => {
        ...
        Controller2 = (0, tslib_1.__decorate)([
            (0, tslib_1.__param)(0, (0, __1.repository)('Note', 'memory')),
            (0, tslib_1.__metadata)("design:paramtypes", [Object])
        ], Controller2);
    ...
    it('supports @repository(model, dataSource)', async () => {
        ...
        Controller3 = (0, tslib_1.__decorate)([
            (0, tslib_1.__param)(0, (0, __1.repository)(Note, ds)),
            (0, tslib_1.__metadata)("design:paramtypes", [Object])
        ], Controller3);
    ...
    it('rejects @repository("")', async () => {
        ...
        Controller4 = (0, tslib_1.__decorate)([
            (0, tslib_1.__param)(0, (0, __1.repository)('')),
            (0, tslib_1.__metadata)("design:paramtypes", [Object])
        ], Controller4);
    ...
    describe('@repository.getter() ', () => {
        it('accepts repository name', async () => {
            ...
            TestController = (0, tslib_1.__decorate)([
                (0, tslib_1.__param)(0, __1.repository.getter('NoteRepository')),
